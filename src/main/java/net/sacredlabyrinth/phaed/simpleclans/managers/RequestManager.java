...
public final class RequestManager
{
    ...
    public void addDemoteRequest(ClanPlayer requester, String demotedName, Clan clan)
    {
        ...
        String msg = MessageFormat.format(SimpleClans.langManager.AskingDemotion, Helper.capitalize(requester.getName()), demotedName);
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.AskingPromotion, Helper.capitalize(requester.getName()), promotedName);
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.AskingDeletion, Helper.capitalize(requester.getName()));
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.invitingJoin, Helper.capitalize(requester.getName()), clan.getName());
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.proposingWar, Helper.capitalize(requestingClan.getName()), Helper.stripColors(allyClan.getColorTag()));
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.proposingEndWar, Helper.capitalize(requestingClan.getName()), Helper.stripColors(rivalClan.getColorTag()));
    ...
    {
        String msg = MessageFormat.format(SimpleClans.langManager.proposingAlliance, Helper.capitalize(requestingClan.getName()), Helper.stripColors(allyClan.getColorTag()));
    ...
    public void addRivalryBreakRequest(ClanPlayer requester, Clan rivalClan, Clan requestingClan)
    {
        ...
        String msg = MessageFormat.format(SimpleClans.langManager.proposingEndRivalry, Helper.capitalize(requestingClan.getName()), Helper.stripColors(rivalClan.getColorTag()));
    ...
    public void processInvite(Request req, VoteResult vote)
    {
        ...
        if (vote.equals(VoteResult.ACCEPT))
        {
            ...
            clan.addBb(ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.joinedTheClan, Helper.capitalize(invited)));
            plugin.getClanManager().serverAnnounce(MessageFormat.format(SimpleClans.langManager.hasJoined, Helper.capitalize(invited), clan.getName()));
            clan.addPlayerToClan(cp);
        }
        else
        {
            clan.leaderAnnounce(ChatColor.RED + MessageFormat.format(SimpleClans.langManager.membershipInvitation, Helper.capitalize(invited)));
        }
    ...
    public void processResults(Request req)
    {
        if (req.getType().equals(ClanRequest.START_WAR))
        {
            ...
            if (war != null && clan != null)
            {
                ...
                if (!accepts.isEmpty())
                {
                    ...
                    war.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.youAtWar, Helper.capitalize(war.getName()), clan.getColorTag()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.youAtWar, Helper.capitalize(clan.getName()), war.getColorTag()));
                }
                else
                {
                    war.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.deniedWarReq, Helper.capitalize(denies.get(0)), clan.getName()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.endWarDenied, Helper.capitalize(war.getName())));
                }
            }
        }
        else if (req.getType().equals(ClanRequest.END_WAR))
        {
            ...
            if (war != null && clan != null)
            {
                ...
                if (!accepts.isEmpty())
                {
                    ...
                    war.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.youAreNoLongerAtWar, Helper.capitalize(accepts.get(0)), clan.getColorTag()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.youAreNoLongerAtWar, Helper.capitalize(clan.getName()), Helper.capitalize(war.getColorTag())));
                }
                else
                {
                    war.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.deniedWarReq, Helper.capitalize(denies.get(0)), clan.getName()));
        ...
        else if (req.getType().equals(ClanRequest.CREATE_ALLY))
        {
            ...
            if (ally != null && clan != null)
            {
                ...
                if (!accepts.isEmpty())
                {
                    ...
                    ally.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.acceptedAlliance, Helper.capitalize(accepts.get(0)), clan.getName()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.createdAlliance, Helper.capitalize(cp.getName()), Helper.capitalize(ally.getName())));
                }
                else
                {
                    ally.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.deniedAlliance, Helper.capitalize(denies.get(0)), clan.getName()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.hasDeniedAlliance, Helper.capitalize(ally.getName())));
                }
            }
        }
        else if (req.getType().equals(ClanRequest.BREAK_RIVALRY))
        {
            ...
            if (rival != null && clan != null)
            {
                ...
                if (!accepts.isEmpty())
                {
                    ...
                    rival.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.brokenRivalry, Helper.capitalize(accepts.get(0)), clan.getName()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.brokenRivalryWith, Helper.capitalize(cp.getName()), Helper.capitalize(rival.getName())));
                }
                else
                {
                    rival.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.deniedMakePeace, Helper.capitalize(denies.get(0)), clan.getName()));
                    clan.addBb(cp.getName(), ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.peaceAgreementDenied, Helper.capitalize(rival.getName())));
                }
            }
        }
        else if (req.votingFinished())
        {
            ...
            if (req.getType().equals(ClanRequest.DEMOTE))
            {
                ...
                if (denies.isEmpty())
                {
                    clan.addBb(SimpleClans.langManager.leaders, ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.demotedBackMember, Helper.capitalize(demoted)));
                    clan.demote(demoted);
                }
                else
                {
                    String deniers = Helper.capitalize(Helper.toMessage(Helper.toArray(denies), ", "));
                    clan.leaderAnnounce(ChatColor.RED + MessageFormat.format(SimpleClans.langManager.deniedDemotion, deniers, demoted));
                }
            }
            else if (req.getType().equals(ClanRequest.PROMOTE))
            {
                ...
                if (denies.isEmpty())
                {
                    clan.addBb(SimpleClans.langManager.leaders, ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.promotedtoLeader, Helper.capitalize(promoted)));
                    clan.promote(promoted);
                }
                else
                {
                    String deniers = Helper.capitalize(Helper.toMessage(Helper.toArray(denies), ", "));
                    clan.leaderAnnounce(ChatColor.RED + MessageFormat.format(SimpleClans.langManager.deniedPromotion, deniers, promoted));
                }
            }
            else if (req.getType().equals(ClanRequest.DISBAND))
            {
                ...
                if (denies.isEmpty())
                {
                    clan.addBb(SimpleClans.langManager.leaders, ChatColor.AQUA + MessageFormat.format(SimpleClans.langManager.hasDisbanded, clan.getName()));
                    clan.disband();
                }
                else
                {
                    String deniers = Helper.capitalize(Helper.toMessage(Helper.toArray(denies), ", "));
                    clan.leaderAnnounce(ChatColor.RED + MessageFormat.format(SimpleClans.langManager.clanDeletion, deniers));
                }
            }
    ...
    public boolean endPendingRequest(String playerName)
    {
        for (Request req : new LinkedList<>(requests.values()))
        {
            for (ClanPlayer cp : req.getAcceptors())
            {
                ...
                {
                    req.getClan().leaderAnnounce(MessageFormat.format(SimpleClans.langManager.signedOffRequestCancelled, ChatColor.RED + Helper.capitalize(playerName), req.getType()));
                    requests.remove(req.getClan().getTag());
                    break;
                }
            }
    ...
    public void ask(Request req)
    {
        ...
        final String options = MessageFormat.format(SimpleClans.langManager.acceptOrDeny, ChatBlock.makeEmpty(Helper.stripColors(tag)) + " " + ChatColor.DARK_GREEN + "/" + plugin.getSettingsManager().getCommandAccept() + plugin.getSettingsManager().getPageHeadingsColor(), ChatColor.DARK_RED + "/" + plugin.getSettingsManager().getCommandDeny());
